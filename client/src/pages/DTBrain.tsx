...
const controlPrinciples = [
  {
    ...
    copy: "Data never leaves the premises.",
    icon: LockKeyhole,
  },
  {
    title: "Direct control",
    copy: "The family office retains full stack ownership.",
    icon: ShieldCheck,
  },
  {
    title: "No cloud dependency",
    copy: "Critical automation does not rely on invasive providers.",
    icon: CloudOff,
  },
  {
    title: "Predictable costs",
    copy: "Stable infrastructure and operating expenses.",
    icon: HardDrive,
  },
];
...
function PrivateBriefingButton({
  ...
  return (
    <BookingWidgetDialog
      variant={variant}
      context="DT Brain private AI booking"
    />
  );
}
      ...
      <main className="pt-20">
          ...
          <div className="container relative grid min-h-[calc(100vh-5rem)] items-center gap-12 py-20 lg:grid-cols-[0.88fr_1.12fr] lg:py-28">
            <motion.div {...fadeUp}>
              ...
              <p className="mt-8 max-w-2xl text-2xl font-semibold leading-9 tracking-[-0.035em] text-[#0A65FF]">
                It runs in your own office. On your own hardware. In your actual
                control.
              </p>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-black/80">
                Digital Therapy sets up a private, on-premises automation
                environment powered by Apple M4 Pro. No cloud dependency. No
                data leaves your ecosystem. That is real security and true
                privacy.
              </p>
              ...
              <div className="relative overflow-hidden rounded-[2.25rem] border border-white/80 bg-white shadow-[0_42px_110px_rgba(16,24,40,0.14)]">
                ...
                <div className="absolute inset-x-5 bottom-5 rounded-[1.4rem] border border-white/70 bg-white/82 p-5 shadow-[0_18px_50px_rgba(16,24,40,0.12)] backdrop-blur-xl">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      <div className="text-xs font-bold uppercase tracking-[0.22em] text-[#0A65FF]">
                        Secure perimeter
                      </div>
                      <div className="mt-2 text-xl font-semibold tracking-[-0.04em]">
                        On-premises automation environment
                      </div>
                    </div>
              ...
              {specs.map(spec => {
                ...
                return (
                  <motion.div
                    ...
                    {...fadeUp}
                    className="group border-t border-black/10 pt-5"
                  >
                    <Icon className="h-6 w-6 text-[#0A65FF] transition-transform duration-300 group-hover:-translate-y-1" />
                    <div className="mt-4 text-2xl font-bold tracking-[-0.04em] text-black">
                      {spec.value}
                    </div>
          ...
          <div className="container relative grid items-start gap-14 lg:grid-cols-[0.78fr_1.22fr]">
            <motion.div {...fadeUp}>
              ...
              <p className="mt-7 max-w-xl text-lg leading-8 text-black/80">
                DT Brain gives the office a controlled local environment for AI
                workflows, document intelligence, scripting, robotic process
                automation, and integration testing before automations touch
                live operations.
              </p>
              <div className="mt-9 grid gap-3">
                {[
                  ...
                  <div
                    key={item}
                    className="flex items-start gap-3 text-base font-semibold text-black/72"
                  >
            ...
            <motion.div
              {...fadeUp}
              className="relative rounded-[2rem] border border-black/8 bg-white p-5 shadow-[0_30px_90px_rgba(16,24,40,0.10)]"
            >
              <div className="rounded-[1.5rem] border border-[#0A65FF]/18 bg-[linear-gradient(145deg,#ffffff_0%,#eef5ff_100%)] p-5 lg:p-7">
                <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
                  <div>
                    <div className="text-xs font-bold uppercase tracking-[0.24em] text-[#0A65FF]">
                      DT Brain core
                    </div>
                    <div className="mt-2 text-3xl font-semibold tracking-[-0.05em]">
                      Apple M4 Pro automation hub
                    </div>
                  </div>
                  <div className="rounded-full border border-black/10 bg-white/70 px-4 py-2 text-sm font-bold text-black/78">
                    1 Gbps Ethernet
                  </div>
                </div>
                      ...
                      {sandboxOne.map(item => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="mt-1 font-semibold tracking-[-0.02em]">
                              {item.title}
                            </div>
                  ...
                  <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-black/72">
                          Encrypted traffic and identity-based access around the
                          secure perimeter.
                        </div>
                      </div>
                    </div>
                    <div className="text-sm font-bold uppercase tracking-[0.18em] text-[#0A65FF]">
                      Secure perimeter
                    </div>
                  </div>
                </div>
        ...
        <section className="border-y border-black/8 bg-white py-24 lg:py-32">
          <div className="container grid items-center gap-14 lg:grid-cols-[1.05fr_0.95fr]">
            <motion.div
              {...fadeUp}
              className="relative overflow-hidden rounded-[2rem] border border-black/8 bg-[#F7F4EE] shadow-[0_30px_90px_rgba(16,24,40,0.10)]"
            >
              <img
                src={heroVisual}
                alt="Digital Therapy operating layer: source systems unified into a governed data warehouse"
                className="aspect-[16/12] w-full object-cover opacity-90"
                width={1536}
                height={1152}
              />
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-semibold tracking-[-0.04em]">
                      Built for controlled family-office automation
                    </div>
                  </div>
                </div>
              </div>
            ...
            <motion.div {...fadeUp}>
              ...
              <p className="mt-7 max-w-xl text-lg leading-8 text-black/80">
                DT Brain is designed for family offices that want the
                productivity of AI automation without surrendering sensitive
                documents, workflows, and operational context to uncontrolled
                infrastructure.
              </p>
        ...
        <section className="bg-[#111111] py-20 text-white lg:py-24">
          <div className="container grid items-center gap-10 lg:grid-cols-[1fr_0.72fr]">
            <motion.div {...fadeUp}>
              <div className="mb-5 text-xs font-bold uppercase tracking-[0.24em] text-[#6DA6FF]">
                Private deployment conversation
              </div>
              <h2 className="max-w-4xl font-display text-[clamp(2.7rem,5.3vw,5.8rem)] leading-[0.9] tracking-[-0.06em]">
                Book 30 minutes to see where private automation should create
                value first.
              </h2>
            </motion.div>
            <motion.div {...fadeUp} className="lg:justify-self-end">
              <p className="max-w-md text-lg leading-8 text-white/66">
                Bring your workflow, reporting, and privacy pain points. We will
                tour DT Brain and other custom solutions already deployed for
                discerning New York City family offices, then identify the best
                place to deliver high-value impact first.
              </p>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row lg:flex-col">
                <PrivateBriefingButton />
                <a
                  href="/"
                  className="inline-flex items-center justify-center rounded-full border border-white/18 px-6 py-3 text-sm font-semibold text-white/80 transition-colors duration-300 hover:border-[#6DA6FF]/60 hover:text-white"
                >
                  Return to main site
                </a>
              </div>
