          ...
          <div className="container grid items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
            <motion.div {...fadeUp}>
              ...
              <p className="mt-6 text-lg leading-8 text-black/80">
                Digital Therapy helps private banks, multifamily offices, and
                wealth advisory firms solve client operating complexity without
                replacing the trusted advisory relationship.
              </p>
              <div className="mt-8">
                <ContactFormDialog
                  variant="secondary"
            ...
            >
              ...
              <div className="absolute bottom-5 left-5 right-5 rounded-[1.4rem] border border-white/70 bg-white/78 p-5 backdrop-blur-xl">
                ...
                <p className="mt-2 text-lg font-semibold tracking-[-0.03em] text-black">
                  Introduce Digital Therapy when a client needs a practical
                  operating blueprint, not another abstract strategy deck.
                </p>
              </div>
            </motion.div>
          </div>
